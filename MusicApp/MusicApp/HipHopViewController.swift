...
class HipHopViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let musicFile = Bundle.main.path (forResource: "hiphop", ofType: ".mp3")
    ...
    @IBAction func PlayMusic(_ sender: UIButton) {musicalEffect.play()
    }
    
    @IBAction func StopMusic(_ sender: UIButton) {musicalEffect.stop()
    }
    /*
    // MARK: - Navigation
